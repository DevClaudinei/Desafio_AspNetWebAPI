...
public class CustomerServiceTests
{
    ...
    public void Should_Fail_When_Executing_CreateCustomer_Because_EmailAlreadyExists()
    {
        ...
        _mockRepositoryFactory.SetupSequence(x => x.Repository<Customer>()
            .Any(It.IsAny<Expression<Func<Customer, bool>>>())).Returns(true).Returns(false);
    ...
    public void Should_Fail_When_Executing_CreateCustomer_Because_CpfAlreadyExists()
    {
        ...
        _mockRepositoryFactory.SetupSequence(x => x.Repository<Customer>()
            .Any(It.IsAny<Expression<Func<Customer, bool>>>())).Returns(false).Returns(true);
    ...
    public void Should_Return_Customers_When_Executing_GetAll()
    {
        ...
        _mockRepositoryFactory.Setup(x => x.Repository<Customer>()
            .Search(It.IsAny<IMultipleResultQuery<Customer>>())).Returns((IList<Customer>)customerFake);
        ...
        _mockRepositoryFactory.Verify(x => x.Repository<Customer>().MultipleResultQuery(), Times.Once());
    ...
    public void Should_Return_Empty_When_Executing_GetAll()
    {
        ...
        _mockRepositoryFactory.Setup(x => x.Repository<Customer>()
            .Search(It.IsAny<IMultipleResultQuery<Customer>>())).Returns(new List<Customer>());
    ...
    public void Should_Return_Customer_When_Executing_GetById()
    {
        ...
        _mockRepositoryFactory.Setup(x => x.Repository<Customer>().SingleResultQuery()
        ...
        _mockRepositoryFactory.Verify(x => x.Repository<Customer>().SingleResultQuery()
    ...
    public void Should_Return_Customers_When_Executing_GetAllByFullName()
    {
        ...
        _mockRepositoryFactory.Setup(x => x.Repository<Customer>()
            .Search(It.IsAny<IQuery<Customer>>())).Returns((IList<Customer>)customerFake);

        // Act
        var customerFound = _customerService.GetAllByFullName(customer.FullName);

        // Assert
        customerFound.Should().HaveCount(2);

        _mockRepositoryFactory.Verify(x => x.Repository<Customer>().MultipleResultQuery()
            .AndFilter(It.IsAny<Expression<Func<Customer, bool>>>()), Times.Once());
    ...
    public void Should_Pass_When_Executing_Update_Customer()
    {
        ...
        _mockUnitOfWork.Setup(x => x.Repository<Customer>().Update(It.IsAny<Customer>()));
        ...
        _mockUnitOfWork.Verify(x => x.Repository<Customer>().Update(It.IsAny<Customer>()), Times.Once());
    ...
    public void Should_Pass_When_Executing_Delete_A_Customer()
    {
        ...
        _mockUnitOfWork.Setup(x => x.Repository<Customer>().Remove(It.IsAny<Expression<Func<Customer, bool>>>()));
    ...
    public void Should_Fail_When_Executing_Delete_A_Customer_Because_Customer_Does_Not_Exists()
    {
        ...
        _mockRepositoryFactory.Setup(x => x.Repository<Customer>().SingleOrDefault(It.IsAny<IQuery<Customer>>()));
